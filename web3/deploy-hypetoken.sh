...
# Script para deploy do HypeToken usando forge create
...
echo ""
echo "🎯 Deployando HypeToken com forge create..."
echo "================================================"

# Executar o deploy do HypeToken com forge create
forge create src/HypeToken.sol:HypeToken \
    --rpc-url "$RPC_URL" \
    --account sepolia \
    --legacy \
...
echo ""
echo "✅ HypeToken deployado!"
echo "📝 Guarde o endereço para usar nos próximos deploys" 