...
import { Menu, X, Wallet, Settings, Users, Trophy, Copy, ExternalLink, RefreshCw, LogOut, ChevronDown, Coins, Shield, Target } from 'lucide-react';
...
export default function Header() {
  ...
  const navigationItems = [
    {
      title: "SPFC Ecosystem",
      description: "Revolucionando o engajamento da torcida tricolor através de tokens e blockchain",
      items: [
        {
          title: "Stake SPFC",
          href: "/stake-spfc",
          description: "Faça stake dos seus tokens SPFC e ganhe recompensas exclusivas",
          icon: Coins,
        },
        {
          title: "Torcida Organizada",
          href: "/torcida-organizada",
          description: "Conecte-se com outras torcidas e participe de eventos exclusivos",
          icon: Shield,
        },
        {
          title: "Predições",
          href: "/predicoes",
          description: "Aposte na performance do time e ganhe tokens baseados em acertos",
          icon: Target,
        },
      ],
    },
