        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-6xl font-black leading-tight text-gray-900">
                <div className="mb-2">De stake na sua paixão</div>
                <div className="text-brand-500 mb-2">Apoie sua torcida</div>
              </h1>
            </div>

            {/* Description */}
            <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
              Transforme seu apoio em financiamento real para sua torcida organizada. 
              Faça staking de Fan Tokens e ganhe benefícios exclusivos enquanto fortalece sua comunidade.
            </p>
          ...
          <div className="relative">
            <div className="relative w-full h-[600px] lg:h-[700px]">
              ...
              {/* Floating Cards - Torcida Style - Z-INDEX FIXED */}
              <div className="absolute top-20 right-8 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float z-20">
                <div className="flex items-center space-x-3">
                  <div className="w-20 h-10 bg-brand-500 rounded-xl flex items-center justify-center">
                    <span className="text-white font-bold text-sm">$SPFC</span>
                  </div>
                  <div>
                    <div className="text-gray-900 font-bold">R$ 1.250</div>
                    <div className="text-green-500 text-sm font-semibold">Staked</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-32 left-8 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float z-20" style={{animationDelay: '1s'}}>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-gray-900 font-bold text-sm">Badge VIP</div>
                    <div className="text-gray-500 text-xs">Nível Ouro</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-40 left-12 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float z-20" style={{animationDelay: '2s'}}>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-gray-900 font-bold text-sm">R$ 15.000</div>
                    <div className="text-gray-500 text-xs">Financiado</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-20 right-16 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float z-20" style={{animationDelay: '0.5s'}}>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-gray-900 font-bold text-sm">Acesso VIP</div>
                    <div className="text-gray-500 text-xs">Eventos Exclusivos</div>
                  </div>
                </div>
              </div>
